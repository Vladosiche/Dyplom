...
MainFrame::MainFrame(const wxString& title) : wxFrame(nullptr, wxID_ANY, title) {// Створення об'єкту вкладок
...
wxStaticText* Text7 = new wxStaticText(panel4, wxID_ANY, "ЕТАЛОН", wxPoint(60, 200));
...
wxStaticText* Text8 = new wxStaticText(panel4, wxID_ANY, "СПІВПАДІННЯ", wxPoint(225, 200));
...
wxStaticText* Text9 = new wxStaticText(panel4, wxID_ANY, "КАНДИДАТ", wxPoint(435, 200));
