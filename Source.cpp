...
//    // Завантаження зображень обличчя
...
//
//    // Конвертування зображень у формат Dlib
    ...
    //if (count >= 4)
    //{
    //    std::cout << "Ви пройшли автентифiкацiю" << std::endl;
    //}
    //else
    //    std::cout << "Нажаль автентифiкацiя не пройдена" << std::endl;
    //system("pause");
